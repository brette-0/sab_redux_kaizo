...
AreaAddrOffsets:
World1Areas: .db $25, $29, $c0, $26, $60 ; Why is it $c0 and not $40?  Does it matter?
...
;      .db $ff
      ...
      .db $6b, Goomba
      .db $8b, PageFlag+Goomba
      .db $63, PageFlag+TwoGoombas
      .db PageSkip, $05
      .db $03, Goomba
      .db $23, Goomba
      .db $4b, PageFlag+TwoGoombas
      .db $bb, GreenKoopa
      .db $5b, PageFlag+TwoGoombas
      .db $fb, TwoGoombas
      .db $3b, PageFlag+TwoGoombas
      .db PageSkip, $0b
      .db $1b, TwoGoombas
      .db $ff
...
L_GroundArea6:
      ...
      ;.db Objects4Flag + $04 * $10, $06 * $10 + $01 - $01
      ...
      .db $c9, Objects1Flag + $06 * $10 + $02 - $01             ; (12,9) Vertical pipe (2 blocks height)
